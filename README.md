...
| ⭐ [**Proyecto Final: Módem FT8 Autónomo (MAP-FT8)**](https://github.com/ManuT18/SistemasEmbebidos_ProyectoFinal) | Espressif ESP32 Dual-Core (240 MHz)         | Procesamiento Digital de Señales (DSP), KissFFT, matrices Costas, decodificación LDPC + CRC14, modulación continua CP-FSK, FreeRTOS, servidor web embebido y WebSockets.                                    |
