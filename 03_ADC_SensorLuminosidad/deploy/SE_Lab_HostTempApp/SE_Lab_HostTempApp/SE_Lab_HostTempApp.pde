...
void setup() {
	...
	f1 = new ScrollingFcnPlot(cantValues, color(100, 0, 0), 0, 110);
	f2 = new ScrollingFcnPlot(cantValues, color(0, 100, 0), 0, 110);
	f3 = new ScrollingFcnPlot(cantValues, color(0, 0, 100), 0, 110);
	f4 = new ScrollingFcnPlot(cantValues, color(100, 100, 0), 0, 110);
	//asd
