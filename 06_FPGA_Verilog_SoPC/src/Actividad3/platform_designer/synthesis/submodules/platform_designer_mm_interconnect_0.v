// platform_designer_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module platform_designer_mm_interconnect_0 (
	...
	wire  [17:0] pio_leds_s1_agent_m0_address;                                                       // pio_LEDS_s1_agent:m0_address -> pio_LEDS_s1_translator:uav_address
	...
	wire  [94:0] pio_leds_s1_agent_rf_source_data;                                                   // pio_LEDS_s1_agent:rf_source_data -> pio_LEDS_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pio_leds_s1_agent_rsp_fifo_out_data;                                                // pio_LEDS_s1_agent_rsp_fifo:out_data -> pio_LEDS_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_LEDS_s1_agent:cp_data
	...
	wire  [17:0] pio_switches_s1_agent_m0_address;                                                   // pio_SWITCHES_s1_agent:m0_address -> pio_SWITCHES_s1_translator:uav_address
	...
	wire  [94:0] pio_switches_s1_agent_rf_source_data;                                               // pio_SWITCHES_s1_agent:rf_source_data -> pio_SWITCHES_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pio_switches_s1_agent_rsp_fifo_out_data;                                            // pio_SWITCHES_s1_agent_rsp_fifo:out_data -> pio_SWITCHES_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> pio_SWITCHES_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_SWITCHES_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // pio_SWITCHES_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_SWITCHES_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> pio_SWITCHES_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> pio_SWITCHES_s1_agent:cp_endofpacket
	...
	wire  [93:0] pio_leds_s1_agent_rp_data;                                                          // pio_LEDS_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pio_switches_s1_agent_rp_valid;                                                     // pio_SWITCHES_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] pio_switches_s1_agent_rp_data;                                                      // pio_SWITCHES_s1_agent:rp_data -> router_007:sink_data
	wire         pio_switches_s1_agent_rp_ready;                                                     // router_007:sink_ready -> pio_SWITCHES_s1_agent:rp_ready
	wire         pio_switches_s1_agent_rp_startofpacket;                                             // pio_SWITCHES_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pio_switches_s1_agent_rp_endofpacket;                                               // pio_SWITCHES_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         pio_switches_s1_agent_rdata_fifo_src_valid;                                         // pio_SWITCHES_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] pio_switches_s1_agent_rdata_fifo_src_data;                                          // pio_SWITCHES_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         pio_switches_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_005:in_0_ready -> pio_SWITCHES_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> pio_SWITCHES_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> pio_SWITCHES_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // pio_SWITCHES_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> pio_SWITCHES_s1_agent:rdata_fifo_sink_error
	...
	platform_designer_mm_interconnect_0_router router (
	...
	platform_designer_mm_interconnect_0_router_001 router_001 (
	...
	platform_designer_mm_interconnect_0_router_002 router_002 (
	...
	platform_designer_mm_interconnect_0_router_002 router_003 (
	...
	platform_designer_mm_interconnect_0_router_004 router_004 (
	...
	platform_designer_mm_interconnect_0_router_004 router_005 (
	...
	platform_designer_mm_interconnect_0_router_002 router_006 (
	...
	platform_designer_mm_interconnect_0_router_002 router_007 (
	...
	platform_designer_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_designer_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
