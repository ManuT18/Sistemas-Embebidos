...
static uint8_t 
    fnqueue_head,               // Apunta a la siguiente función a ejecutar
	fnqueue_tail,               // Apunta al proximo lugar libre de la cola para escribir
	fnqueue_count;              // Cantidad de elementos en la cola
